...
<body>
    <div class="container mx-auto p-6">
        ...
        <div class="flex gap-2 mt-5">
            <div class="bg-secondary rounded-md p-3 w-[40%]">
                <h4 class="text-primary text-[16px]">Active Carts</h4>
                <h1 class="text-primary !text-[42px] font-semibold">00.0</h1>
            </div>
            <div class="bg-secondary rounded-md p-3 w-[40%]">
                <h4 class="text-primary text-[16px]">Assisted Carts</h4>
                <h1 class="text-primary !text-[42px] font-semibold">00.0</h1>
            </div>
            <div class="bg-secondary rounded-md p-3 w-[40%]">
                <h4 class="text-primary text-[16px]">Conversions (USD)</h4>
                <div class="flex justify-start items-center gap-4">
                    <h1 class="text-primary !text-[44px] font-semibold">00.0</h1>
                    <h6 class="bg-secondary rounded-md text-primary px-3 p-[1px] mt-2">00.0 (%)</h6>
                </div>
            </div>
            <div class="bg-secondary rounded-md p-3 w-[40%]">
                <h4 class="text-primary text-[16px]">Assisted Conversions (USD)</h4>
                <div class="flex justify-start items-center gap-4">
                    <h1 class="text-primary !text-[44px] font-semibold">00.0</h1>
                    <h6 class="bg-secondary rounded-md text-primary px-3 p-[1px] mt-2">00.0 (%)</h6>
                </div>
    ...
    <div class="bg-secondary p-4 w-full rounded-lg mt-4">
      ...
      <canvas id="lineChart3" height="50"></canvas>
        ...
        <!-- table -->
        <h1 class="text-[#3F3F3F] font-semibold mt-2 text-[19px]">Conversions</h1>
            ...
            <table class="min-w-full border-separate !rounded-lg border-spacing-y-2">
                ...
                <tbody class="text-sm text-gray-700 border !border-1">
                    <tr class="bg-white shadow rounded-lg">
                        ...
                        <td class="px-4 py-2 font-medium flex items-center gap-2"><span class="bg-secondary text-[#3F3F3F] px-2 py-1 rounded-full flex justify-center items-center">EJ</span> Google Inc.</td>
                    </tr>
                    <tr class="bg-white shadow rounded-lg">
                        <td class="px-4 py-4 flex items-center">
                            <input type="checkbox" />
        ...
        <div class="flex justify-between items-center gap-2 mt-5">
            <button class="border-primary !border-1 flex justify-center items-center gap-2 text-primary py-2 px-3 rounded-lg">
