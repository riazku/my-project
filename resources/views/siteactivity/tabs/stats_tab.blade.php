...
<html lang="en">
  ...
  <body>
    <div class="container mx-auto p-6">
      ...
      <div class="flex gap-2 mt-5">
        <div class="w-[10%] !border-1 border-[#CAD7EC] rounded-md p-3  h-[75px] flex justify-center items-center text-[#3F3F3F]">00.0</div>
        <div class="!border-1 border-[#CAD7EC] rounded-md p-3 w-[40%] h-[75px]">
        </div> 
          <div class="!border-1 border-[#CAD7EC] rounded-md p-3 w-[40%]">
        </div> 
          <div class="!border-1 border-[#CAD7EC] rounded-md p-3 w-[40%]">
        </div> 
      </div>
  <div class="flex gap-2 mt-1">
     ...
     <div class="flex gap-2 mt-5">
        ...
        <h1 class="text-[#3F3F3F] font-bold text-[19px]">All Site Events</h1>
        <div class="flex justify-center items-center gap-2 md:ml-10 ml-0">
          <button
            class="border-[#CFD5DF80] bg-[#ebeff3] !!border-1 gap-6 text-[#3F3F3F] flex !justify-between items-center rounded-md px-3 p-1"
          >
