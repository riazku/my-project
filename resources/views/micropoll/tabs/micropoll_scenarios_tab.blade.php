...
<body>
    <div class="container mx-auto p-6">
        ...
        {{-- <div class="flex space-x-1 mb-6">
            <button class="px-3 py-1.5 rounded-lg border border-gray-300  text-sm font-semibold">My Campaigns</button>
            <button class="px-3 py-1.5 font-bold rounded-lg bg-secondary text-primary text-primary text-sm ">Scenarios</button>
        </div> --}}
        ...
        <div class="bg-white p-6 rounded-lg border border-gray-300 shadow">
            ...
            <div class="grid grid-cols-2 gap-4 mt-6">
                ...
                <div class="bg-secondary p-4 rounded-lg">
                    <h4 class="text-lg font-semibold text-primary mb-2">Confirm dsfsdfsffdsfsubscription</h4>
