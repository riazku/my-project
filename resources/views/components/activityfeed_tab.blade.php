...
<html lang="en">
  ...
  <div class="fixed z-20 top-[123px] left-[320px] right-0 z-10 bg-white">
    ...
    <button
        id="activityfeed-flow-tab"
        class="tab-button text-black px-4 py-2 !border-1 !border-gray-200 rounded-md"
        data-content-route="{{ route('activityfeed.tabs.flow_tab') }}"
    ...
    <button
        id="activityfeed-playground-tab"
        class="tab-button text-black px-4 py-2 !border-1 !border-gray-200 rounded-md"
        data-content-route="{{ route('activityfeed.tabs.playground_tab') }}"
         data-content-target="tab-content"
          data-default-tab="true"
    >
        Playground
