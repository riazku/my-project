...
<div class="h-screen">
    ...
    <div>
     @include('components.catalog_tab')
    </div>
    ...
    <div class=" w-[77%] mx-auto mt-45 ml-48" x-data="{ activeTab: 'catalog-search-tab' }">
...
{{-- <script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const defaultTabButton = document.getElementById('catalog-search-tab');
        if (defaultTabButton) {
