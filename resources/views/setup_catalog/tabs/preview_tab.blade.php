        ...
        <div class="flex-1 flex flex-col">
            ...
            <div class="flex-1">
                ...
                <div class="px-6 py-6">
                    ...
                    <div class="w-auto h-[320px] rounded-[6px] border border-[#EEEAFF] p-3 bg-secondary"></div>
                    
                    <button class="bg-primary text-white px-4 py-2 rounded text-sm font-medium hover:bg-secondary mt-10">
                        Preview Products
                    </button>
                </div>
            </div>
